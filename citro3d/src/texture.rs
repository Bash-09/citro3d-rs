...
impl TextureParameters {
    ...
    pub const fn new_2d(width: u16, height: u16, format: Format) -> TextureParameters {
        TextureParameters {
            width,
            height,
            max_level: 0,
    ...
    pub fn new_2d_with_mipmap(width: u16, height: u16, format: Format) -> TextureParameters {
        TextureParameters {
            width,
            height,
    ...
    pub const fn new_2d_in_vram(width: u16, height: u16, format: Format) -> TextureParameters {
        TextureParameters {
            width,
            height,
            max_level: 0,
