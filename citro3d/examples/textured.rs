...
use citro3d::{attrib, buffer, shader, texture};
...
static TEXTURE_BYTES: &[u8] = include_bytes!("assets/logo.bin");
...
// Make a little checkered grid
fn create_texture() -> texture::Texture {
    let params = texture::TextureParameters::new_2d(64, 64, texture::Format::RGBA8);
